                    ...
                    <div class="streamline message-box message-nicescroll-bar">
                        <div class="sl-item">
                            <div class="sl-avatar avatar avatar-sm avatar-circle">
                                <img class="img-responsive img-circle" src="{{asset('dist/img/user.png')}}"
                                    alt="avatar" />
                            </div>
                        ...
                        <div class="sl-item">
                            <div class="sl-avatar avatar avatar-sm avatar-circle">
                                <img class="img-responsive img-circle" src="{{asset('dist/img/user4.png')}}"
                                    alt="avatar" />
                            </div>
                            <div class="sl-content">
                                <a href="javascript:void(0)" class="inline-block capitalize-font  pull-left">Sandy
                ...
                <li>
                    <form action="{{route('doctor.logout')}}" method="post">
                        ...
                        <button type="Submit" class="btn btn-success"> <i
                                class="fa fa-fw fa-power-off"></i>Doctor Logout</button>
                    </form>
