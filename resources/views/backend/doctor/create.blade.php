								...
								<div class="form-wrap">
									<form class="form-horizontal" method="post" action="{{route('doctor.store')}}"
										...
										<div class="form-group">
											<label for="exampleInputuname_4" class="col-sm-3 control-label">Docotor
												Name</label>
											<div class="col-sm-9">
												...
												<select name="specialist" id="" class="form-control">
													...
													@foreach($specialists as $specialist)	
														<option value="{{$specialist->id}}"
															@selected(old('specialist') == $specialist->id)>
											...
											<div class="col-sm-9">
												<div class="input-group">
													<input type="password" name="password" class="form-control"
														id="exampleInputuname_4" placeholder="Enter password">
														@error('password')
														<div class="alert alert-danger">{{$message}}</div>
													@enderror
												</div>
