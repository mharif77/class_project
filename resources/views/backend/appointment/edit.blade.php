        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">edit appointment Form</h6>
                    </div>
                                    ...
                                    <form class="form-horizontal" method="post"
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputuname_4"
                                                class="col-sm-3 control-label">appointment</label>
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="specialist"
                                                        value="{{$specialist->name}}" id="exampleInputuname_4"
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <textarea type="text" name="details" class="form-control"
                                                        ...
                                                        rows="10">{{$specialist->details}}</textarea>
                                                        <div class="input-group-addon"><i class="icon-user"></i></div>
