        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">New appointment Form</h6>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-wrap">
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputuname_4" class="col-sm-3 control-label">remarks</label>
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="remarks" id="exampleInputuname_4"
